...
#[maybe_async::maybe_async]
#[rstest]
#[case::empty("resources/utf16le/empty.txt", Stats::new(Some(0), Some(0), Some(0), Some(2), Some(0)))]
#[case::french("resources/utf16le/french.txt", Stats::new(Some(0), Some(10), Some(58), Some(118), Some(58)))]
#[case::spanish("resources/utf16le/spanish.txt", Stats::new(Some(1), Some(3), Some(19), Some(40), Some(18)))]
#[case::small("resources/utf16le/small.txt", Stats::new(Some(1), Some(3), Some(18), Some(38), Some(17)))]
#[trace]
