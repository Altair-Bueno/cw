...
#[test]
fn gabriel() {
    let out = proccess_file_test("resources/utf16/Gabriel.txt");
...
#[ignore]
fn world() {
    let out = proccess_file_test("resources/utf16/world192.txt");
    let expected = Stats::new(
        Some(65119),
        Some(326075),
        Some(2473400),
...
#[test]
fn s1() {
    let out = proccess_file_test("resources/utf16/sample1.txt");
...
#[test]
fn s2() {
    let out = proccess_file_test("resources/utf16/sample2.txt");
    let expected = Stats::new(Some(12), Some(423), Some(2859), Some(5720), Some(635));
    assert_eq!(out, expected)
}
#[test]
fn s3() {
    let out = proccess_file_test("resources/utf16/sample3.txt");
    let expected = Stats::new(Some(20), Some(546), Some(3541), Some(7084), Some(818));
    assert_eq!(out, expected)
}
#[test]
fn small() {
    let out = proccess_file_test("resources/utf16/small.txt");
    let expected = Stats::new(Some(1), Some(3), Some(18), Some(38), Some(17));
    assert_eq!(out, expected)
}
#[test]
fn empty() {
    let out = proccess_file_test("resources/utf16/empty.txt");
...
#[test]
fn spanish() {
    let out = proccess_file_test("resources/utf16/spanish.txt");
...
#[test]
fn french() {
    let out = proccess_file_test("resources/utf16/french.txt");
